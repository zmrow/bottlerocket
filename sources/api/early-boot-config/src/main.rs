...
use provider::aws::AwsDataProvider;

#[cfg(bottlerocket_platform = "aws-dev")]
use {provider::local_file::LocalFileDataProvider, std::path::Path};

#[cfg(bottlerocket_platform = "vmware")]
use provider::cdrom::CdromDataProvider;
...
mod error {
    ...
    pub(super) enum Error {
        ...
        ProviderError { source: crate::provider::Error },
